...
public enum ActionState {
	...
	TURN_RUN_LEFT(false, true, true, InitAnimations.animations.get("Player_run")),
	TURN_RUN_RIGHT(false, true, true, InitAnimations.animations.get("Player_run")),
	TURN_RUN_ON_SLOPE_LEFT(false, true, false, InitAnimations.animations.get("Player_run")),
	TURN_RUN_ON_SLOPE_RIGHT(false, true, false, InitAnimations.animations.get("Player_run")),;
